...
Rails.application.routes.draw do
  ...
  # resources :products              # This simplifies the routing for all CRUD actions for products
    ...
    resources :products do
      resources :subscribers, only: [ :create, :index]    # nested routes with path parameters. You can create a subscriber for a specific product.  Only allows create action (no show, etc.).
